; Listing generated by Microsoft (R) Optimizing Compiler Version 19.29.30133.0 
	...
	TITLE	C:\cpython\externals\zlib-1.2.11\contrib\vstudio\vc14\x86\TestZlibDebug\Tmp\testzlib.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
$SG95782 DB	'rb', 00H
	ORG $+5
$SG95843 DB	'run TestZlib <File> [BlockSizeCompress] [BlockSizeUncomp'
	DB	'ress] [compres. level]', 0aH, 00H
$SG95846 DB	'error reading %s', 0aH, 00H
	ORG $+2
$SG95847 DB	'file %s read, %u bytes', 0aH, 00H
$SG95851 DB	'1.2.11', 00H
	ORG $+1
$SG95852 DB	'total compress size = %u, in %u step', 0aH, 00H
	ORG $+2
$SG95853 DB	'time = %u msec = %f sec', 0aH, 00H
	ORG $+3
$SG95854 DB	'defcpr time QP = %u msec = %f sec', 0aH, 00H
	ORG $+1
$SG95855 DB	'defcpr result rdtsc = %I64x', 0aH, 0aH, 00H
	ORG $+2
$SG95856 DB	'1.2.11', 00H
	ORG $+1
$SG95857 DB	'total uncompress size = %u, in %u step', 0aH, 00H
$SG95858 DB	'time = %u msec = %f sec', 0aH, 00H
	ORG $+3
$SG95859 DB	'uncpr  time QP = %u msec = %f sec', 0aH, 00H
	ORG $+1
$SG95860 DB	'uncpr  result rdtsc = %I64x', 0aH, 0aH, 00H
	ORG $+2
$SG95863 DB	'compare ok', 0aH, 00H
_DATA	ENDS
...
; 967  :     __asm    {
; 968  :         mov     ecx, ShiftCount

	mov	ecx, DWORD PTR _ShiftCount$[ebp]

; 969  :         mov     eax, dword ptr [Value]

	mov	eax, DWORD PTR _Value$[ebp]

; 970  :         mov     edx, dword ptr [Value+4]
