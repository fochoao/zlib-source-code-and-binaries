; Listing generated by Microsoft (R) Optimizing Compiler Version 19.29.30133.0 
	...
	TITLE	C:\cpython\externals\zlib-1.2.11\contrib\vstudio\vc14\x86\TestZlibDebug\Tmp\inflate.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_DATA	SEGMENT
$SG92825 DB	'1.2.11', 00H
	ORG $+1
$SG93385 DB	'incorrect header check', 00H
	ORG $+1
$SG93387 DB	'unknown compression method', 00H
	ORG $+1
$SG93391 DB	'invalid window size', 00H
$SG93395 DB	'unknown compression method', 00H
	ORG $+1
$SG93397 DB	'unknown header flags set', 00H
	ORG $+3
$SG93444 DB	'header crc mismatch', 00H
$SG93461 DB	'invalid block type', 00H
	ORG $+1
$SG93465 DB	'invalid stored block lengths', 00H
	ORG $+3
$SG93477 DB	'too many length or distance symbols', 00H
$SG93481 DB	'invalid code lengths set', 00H
	ORG $+3
$SG93491 DB	'invalid bit length repeat', 00H
	ORG $+2
$SG93497 DB	'invalid bit length repeat', 00H
	ORG $+2
$SG93500 DB	'invalid code -- missing end-of-block', 00H
	ORG $+3
$SG93502 DB	'invalid literal/lengths set', 00H
$SG93504 DB	'invalid distances set', 00H
	ORG $+2
$SG93518 DB	'invalid literal/length code', 00H
$SG93529 DB	'invalid distance code', 00H
	ORG $+2
$SG93539 DB	'invalid distance too far back', 00H
	ORG $+2
$SG93552 DB	'incorrect data check', 00H
	ORG $+3
$SG93557 DB	'incorrect length check', 00H
_DATA	ENDS
...
; 204  :     if (version == Z_NULL || version[0] != ZLIB_VERSION[0] ||
	...
	mov	ecx, 1
	imul	edx, ecx, 0
	movsx	ecx, BYTE PTR $SG92825[edx]
	cmp	eax, ecx
...
; 681  :                 strm->msg = (char *)"incorrect header check";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG93385
...
; 686  :                 strm->msg = (char *)"unknown compression method";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG93387
...
; 695  :                 strm->msg = (char *)"invalid window size";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG93391
...
; 710  :                 strm->msg = (char *)"unknown compression method";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG93395
...
; 715  :                 strm->msg = (char *)"unknown header flags set";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG93397
...
; 823  :                     strm->msg = (char *)"header crc mismatch";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG93444
...
; 882  :                 strm->msg = (char *)"invalid block type";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG93461
...
; 891  :                 strm->msg = (char *)"invalid stored block lengths";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG93465
...
; 930  :                 strm->msg = (char *)"too many length or distance symbols";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG93477
...
; 952  :                 strm->msg = (char *)"invalid code lengths set";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG93481
...
; 998  :                         strm->msg = (char *)"invalid bit length repeat";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG93497
...
; 1012 :                 strm->msg = (char *)"invalid code -- missing end-of-block";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG93500
...
; 1026 :                 strm->msg = (char *)"invalid literal/lengths set";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG93502
...
; 1035 :                 strm->msg = (char *)"invalid distances set";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG93504
...
; 1087 :                 strm->msg = (char *)"invalid literal/length code";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG93518
...
; 1123 :                 strm->msg = (char *)"invalid distance code";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG93529
...
; 1153 :                         strm->msg = (char *)"invalid distance too far back";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG93539
...
; 1212 :                     strm->msg = (char *)"incorrect data check";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG93552
...
; 1225 :                     strm->msg = (char *)"incorrect length check";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG93557
